...
describe('total likes', () => {
  test('of one blog post is the blog post\'s likes', () => {
    const blogs = [{
...
describe('most liked blog', () => {
  ...
  // assuming that all blogs in array will have a 'likes' property
  test('of array of one blog to be the one blog', () => {
    expect(listHelper.favoriteBlog(new Array(blogs[0]))).toEqual(blogs[0])
  })
  ...
  test('of multiple blogs to be the most liked blog', () => {
    expect(listHelper.favoriteBlog(blogs)).toEqual(blogs[2])
  })

  test('of multiple blogs with same amount of likes to be the first one', () => {
    const blogs = [
      {
        title: 'first blog',
        likes: 2,
...
describe('author with most blogs', () => {
  ...
  test('of one blog to be the one blog', () => {
    expect(listHelper.mostBlogs([blogs[0]])).toEqual({author: 'Michael Chan', blogs: 1})
  })

  test('of multiple blogs to be calculated correctly', () => {
...
describe('author with most likes', () => {
  ...
  test('of many blogs to be the most liked author', () => {
